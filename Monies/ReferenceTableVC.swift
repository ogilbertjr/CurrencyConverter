...
class ReferenceTableVC: UITableViewController, ReferenceTableLanguageSupport {
    ...
    override func viewDidLoad() {
        ...
        initializeAvailableCurreniesInLanguage()
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = Array(listOfCurrencies)[indexPath.row].key + "-" + Array(listOfCurrencies)[indexPath.row].value
    ...
    func initializeAvailableCurreniesInLanguage() {
        listOfCurrencies = availableCurrencies
    }
